    ...
    <section class="content">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <div class="row">
                                    <div class="col-md-4 text-center"><label for="studentId">学号: </label></div>
                                    <div class="col-md-8">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h2 class="box-title">社团信息</h2>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-4 text-center"><label for="association">社团: </label></div>
                                    <div class="col-md-8">
                                        <select name="association" id="association">
                                            <option value="001">科技实践部</option>
                                            <option value="002">人事部</option>
                                            <option value="003">常务部</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-4 text-center"><label for="role">角色: </label></div>
                                    <div class="col-md-8">
                                        <select name="role" id="role">
                                            <option value="001">社长</option>
                                            <option value="002">副社长</option>
                                            <option value="003">普通成员</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <button class="btn btn-default">暂存</button>
