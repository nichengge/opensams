...
<body class="hold-transition sidebar-mini" style="margin-top: 7%;">
<div class="row">
    <div class="col-md-12">
        <div class="error-page">
            ...
            <div class="error-content">
                <h3><i class="fa fa-warning text-blue"></i> 您没有此操作权限!</h3>

                <p>
                    如有需要，请联系管理员添加权限。
                </p>

                <form class="search-form" action="https://www.baidu.com/s" method="get">
